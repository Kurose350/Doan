...
public class PlayerController : MonoBehaviour
{
    ...
    private void InputMovement()
    {
        ...
        moveX = keyboardInput + joystickInput;
    }

    void InputJump()
    {
        if ((Input.GetKeyDown(KeyCode.W) || joystick.Vertical > 0) && IsGrounded())
        {
            isJumping = true;
        ...
        if ((Input.GetKeyDown(KeyCode.W) || joystick.Vertical > 0) && isJumping)
        {
